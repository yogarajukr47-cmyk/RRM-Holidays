...
const WHATSAPP_URL = `https://wa.me/919108597154?text=${encodeURIComponent("Hi! I'm looking for destinations in Tamil Nadu with RRM Holidays.")}`;

export default function TamilNaduNotFound() {
  return (
      ...
      <div className="relative z-10 max-w-md w-full text-center">
        <div className="bg-neutral-900/50 backdrop-blur-xl border border-white/5 rounded-2xl p-8 md:p-10">
          ...
          <p className="text-neutral-400 text-sm leading-relaxed mb-8">
            This Tamil Nadu destination doesn&apos;t exist or may have been moved. Explore our popular Tamil Nadu destinations!
          </p>

          <div className="flex flex-wrap justify-center gap-2 mb-8">
            {['Ooty', 'Chennai', 'Madurai', 'Rameswaram', 'Kodaikanal'].map((place) => (
              <Link
                key={place}
                href={`/destinations/tamilnadu/${place.toLowerCase()}`}
