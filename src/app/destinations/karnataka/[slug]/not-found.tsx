...
const WHATSAPP_URL = `https://wa.me/919108597154?text=${encodeURIComponent("Hi! I'm looking for destinations in Karnataka with RRM Holidays.")}`;

export default function KarnatakaNotFound() {
  return (
    <div className="min-h-screen bg-neutral-950 flex items-center justify-center px-4 py-20">
      <div className="fixed inset-0 pointer-events-none overflow-hidden">
        <div className="absolute top-1/4 left-1/3 w-72 h-72 bg-purple-500/5 rounded-full blur-3xl" />
      ...
      <div className="relative z-10 max-w-md w-full text-center">
        <div className="bg-neutral-900/50 backdrop-blur-xl border border-white/5 rounded-2xl p-8 md:p-10">
          ...
          <p className="text-neutral-400 text-sm leading-relaxed mb-8">
            This Karnataka destination doesn&apos;t exist or may have been moved. Explore our popular Karnataka destinations!
          </p>

          {/* Quick links */}
          <div className="flex flex-wrap justify-center gap-2 mb-8">
            {['Mysuru', 'Coorg', 'Hampi', 'Bengaluru', 'Chikmagalur'].map((place) => (
              <Link
                key={place}
                href={`/destinations/karnataka/${place.toLowerCase()}`}
