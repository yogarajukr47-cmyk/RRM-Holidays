...
const VEHICLE_DATA: Record<number, {
  ...
  1: { id: 1, type: 'Sedan', model: 'Toyota Etios', img: '/sedan-etios.jpg', seats: '4 Seaters', pricePerKm: '₹14', badge: null, badgeColor: '', features: ['AC', 'Music System', 'Comfortable Seats', 'Boot Space'], desc: 'Perfect for small family trips and city tours', ac: 'Full AC', luggage: '2 large suitcases + 2 small bags', music: 'FM/USB/Bluetooth', transmission: 'Automatic' },
  ...
  4: { id: 4, type: 'Premium MUV', model: 'Innova Crysta', img: '/innova-crysta.jpg', seats: '7 Seaters', pricePerKm: '₹22', badge: 'Premium', badgeColor: 'bg-violet-500', features: ['Premium AC', 'Luxury Seats', 'Entertainment System', 'Captain Seats'], desc: 'Premium comfort for luxury travel experiences', ac: 'Rear AC + Captain Seat AC', luggage: '4 large suitcases + hand luggage', music: 'Touchscreen + FM/USB/DVD', transmission: 'Automatic' },
  5: { id: 5, type: 'Tempo Traveller', model: 'Force Tempo Traveller', img: '/tempo-traveller.jpg', seats: '12 Seaters', pricePerKm: '₹25', badge: null, badgeColor: '', features: ['Pushback Seats', 'AC', 'Music System', 'Ample Luggage'], desc: 'Best for medium groups, corporate trips and family outings', ac: 'Powerful AC', luggage: 'Overhead + rear cabin', music: 'FM/USB', transmission: 'Manual' },
  ...
  7: { id: 7, type: 'Bus', model: '25 Seater Bus', img: '/bus-25seater.jpg', seats: '25 Seaters', pricePerKm: '₹35', badge: null, badgeColor: '', features: ['Pushback Seats', 'AC', 'Music System', 'PA System'], desc: 'Ideal for large groups, school trips and corporate outings', ac: 'Full AC', luggage: 'Under-seat + separate hold', music: 'PA System + USB', transmission: 'Manual' },
  8: { id: 8, type: 'Bus', model: '33 Seater Bus', img: '/bus-33seater.jpg', seats: '33 Seaters', pricePerKm: '₹38', badge: null, badgeColor: '', features: ['Recliner Seats', 'AC', 'Entertainment', 'PA System'], desc: 'Spacious bus for pilgrimage tours and large group travel', ac: 'Full AC', luggage: 'Under-seat + separate hold', music: 'PA System + Entertainment', transmission: 'Manual' },
  9: { id: 9, type: 'Luxury Bus', model: '50 Seater Luxury Coach', img: '/bus-50seater.jpg', seats: '50 Seaters', pricePerKm: '₹45', badge: 'Luxury', badgeColor: 'bg-cyan-500', features: ['Recliner Seats', 'AC', 'Entertainment', 'PA System', 'WiFi'], desc: 'Luxury Volvo coach for very large groups, pilgrimages & tours', ac: 'Dual Zone AC', luggage: 'Large under-belly + overhead', music: 'PA System + WiFi + TV', transmission: 'Automatic' },
  10: { id: 10, type: 'Tempo Traveller', model: 'Force Urbania 10 Seater', img: '/urbania-10.jpg', seats: '10 Seaters', pricePerKm: '₹33', badge: 'New', badgeColor: 'bg-emerald-500', features: ['Pushback Seats', 'AC', 'Music System', 'Ample Luggage'], desc: 'Compact yet spacious 10-seater Force Urbania, perfect for medium-sized groups exploring South India. Modern design, powerful AC, and superior ride comfort compared to older tempo travellers.', ac: 'Powerful AC', luggage: 'Rear cabin + overhead', music: 'FM/USB/Bluetooth', transmission: 'Manual' },
